...
void *philosopher(void *t_id)
{
    ...
    while(*(int*) t_id != -1)
    {
        ...
        //pick up first fork
        pthread_mutex_lock(&fork_mutex[first_fork]);
        ...
        pthread_mutex_unlock(&fork_mutex[second_fork]);
