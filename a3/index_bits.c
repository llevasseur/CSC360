...
void unset_block(unsigned char buffer[], int block_num)
{
    ...
    printf("Index: %d\n", index);
    printf("Bit Index: %d\n", bit_index);
    buffer[index] &= ~(1UL << bit_index); //set a bit value back to zero
}
...
int main()
{
	...
	// 5/8 = 0
	//5%8 = 5 -> 00100000 set the 5th bit to 1 so 32(base 10) 20(base 16)
	...
	//579 / 8 = 72
	//579%8 = 3 -> 00001000 set the 3rd bit to 1 so 8(base 10) 08(base 16)
    print_buffer(buffer, 512);
